...
} U2FHID_FRAME; // solo (CTAPHID_PACKET)
...
#define FIDO_USAGE_FIDOHID      0x01    // U2FHID usage for top-level collection
...
#define U2FHID_CBOR         (TYPE_INIT | 0x10)  // FIDO2
...
#define CAPFLAG_CBOR            0x04    // 參考 solo 的 CAPABILITY_CBOR
#define CAPFLAG_NMSG            0x08    // not implement ctaphid_msg function
