...
struct softu2f_ctx {
  ...
  // DriverKit: 利用這個取得 Browser 傳來的 FIDO資料
  ...
  softu2f_hid_message_handler cbor_handler;
};
...
#ifdef OUTPUT_SOFTU2F_LOGFILE
    #define softu2f_log(CTX,fmt,...) {log_info(fmt, ##__VA_ARGS__); }     // For 輸出檔案
#else
